            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4">
                    <div class="login-wrap p-0">
                        <img src="{{ asset('assets') }}/img/ziepos.png" alt="" class="text-center mb-4 rounded-circle" style="width: 5.5em; height:5em; display: block; margin-left: auto; margin-right: auto;">
