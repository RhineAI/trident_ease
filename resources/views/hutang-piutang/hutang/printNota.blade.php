...
<body onload="window.print()">
    ...
    <div class="button ml-4 align-items-end">
        <a href="{{ route('admin.data-hutang.index') }}" class="mb-3 mt-3 btn btn-sm btn-secondary ml-4 d-print-none btn-print" id="btn-back"><i class="fas fa-arrow-rotate-left"></i> Back</a>
