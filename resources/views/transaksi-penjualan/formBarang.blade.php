...
<div class="modal fade" id="formModalBarangPenjualan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg dt-responsive" role="document" style="width: 95%">
        ...
        <div class="modal-body table-responsive">
            <table id="tbl-data-barang-penjualan" class="table table-striped table-bordered table-hover table-compact table-responsive dt-responsive" style="width: 100%;">
                <thead>
                    <tr>
                        <td>No</td>
                        <td>Barcode</td>
