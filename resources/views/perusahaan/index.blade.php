            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <div class="form-group" style="width: 95%; margin: auto;">
                        ...
                        <input type="text" class="form-control" id="alamat" placeholder="Alamat Perusahaan"
                            name="alamat" value="{{ $cPerusahaan->alamat }}">
                    </div>
                </div>
                ...
                <button type="button" id="tombol" class="btn btn-primary"
                    style="display: none; margin-left: 0,25rem; margin-right: 10px;">Reset Image</a>
