  ...
  <body onload="window.print()">
    <div class="button ml-4 align-items-end">
        @if (auth()->user()->hak_akses == 'admin')
            <a href="{{ route('admin.laporan-harian.index') }}" class="mb-3 mt-3 btn btn-sm btn-secondary ml-4 d-print-none"><i class="fas fa-arrow-rotate-left"></i> Back</a>
        @elseif (auth()->user()->hak_akses == 'owner')
            <a href="{{ route('owner.laporan-harian.index') }}" class="mb-3 mt-3 btn btn-sm btn-secondary ml-4 d-print-none"><i class="fas fa-arrow-rotate-left"></i> Back</a>
        @endif
        <button onclick="window.print()" class="mb-3 mt-3 btn btn-sm btn-danger ml-4 d-print-none"><i class="fas fa-print"></i> Print PDF</button>
    </div>
    ...
    <div class="col-md-12 mt-3">
        <div class="table-responsive p-2 mt-4">
            <div class="tbl">
                ...
                <table style="" class="table mb-5 table-bordered table-striped table-penjualan" id="dataTableHover">
                    {{-- <thead>
                        <tr>
            ...
            <div class="tbl">
                    ...
                    <table style="" class="table mb-5 table-bordered table-striped table-pembelian" id="dataTableHover">
                        {{-- <thead >
                            <tr>
                                <th width="4%" class="text-center">No</th>
            ...
            <div class="tbl">
                ...
                <table style="" class="table mb-5 table-bordered table-striped table-retur-penjualan" id="dataTableHover">
                    {{-- <thead >
                        <tr>
                            <th width="4%" class="text-center">No</th>
            ...
            <div class="tbl">
                ...
                <table style="" class="table mb-5 table-bordered table-striped table-retur-pembelian" id="dataTableHover">
                    {{-- <thead >
                        <tr>
                            <th width="4%" class="text-center">No</th>
                            <th width="10.5%" class="text-center">Kode</th>
            ...
            <div class="tbl">
                    ...
                    <table style="" class="table mb-5 table-bordered table-striped table-hutang" id="dataTableHover">
                        {{-- <thead >
                            <tr>
                                <th width="4%" class="text-center">No</th>
            ...
            <div class="tbl">
                    ...
                    <table style="" class="table mb-5 table-bordered table-striped table-piutang" id="dataTableHover">
                        {{-- <thead >
                            <tr>
                                <th width="4%" class="text-center">No</th>
                                <th width="6%" class="text-center">Invoice</th>
            ...
            <div class="tbl">
                    ...
                    <table style="" class="table mb-5 table-bordered table-striped table-kas-masuk" id="dataTableHover">
                        {{-- <thead >
                            <tr>
                                <th width="4%" class="text-center">No</th>
            ...
            <div class="tbl">
                ...
                <table style="" class="table mb-5 table-bordered table-striped table-kas-keluar" id="dataTableHover">
                    {{-- <thead >
                        <tr>
                            <th width="4%" class="text-center">No</th>
                            <th width="13%" class="text-center">Tanggal</th>
