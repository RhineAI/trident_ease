  ...
  <body onload="window.print()">
    <div class="button ml-4 align-items-end">
        @if (auth()->user()->hak_akses == 'admin')
            <a href="{{ route('admin.laporan-hutang.index') }}" class="mb-3 mt-3 btn btn-sm btn-secondary ml-4 d-print-none"><i class="fas fa-arrow-rotate-left"></i> Back</a>
        @elseif (auth()->user()->hak_akses == 'owner')
            <a href="{{ route('owner.laporan-hutang.index') }}" class="mb-3 mt-3 btn btn-sm btn-secondary ml-4 d-print-none"><i class="fas fa-arrow-rotate-left"></i> Back</a>
        @endif
        ...
        <div class="table-responsive p-2">
            ...
            <table border="1" class="table mb-5 table-bordered table-striped table-hutang" id="dataTableHover">
                <thead class="table-secondary">
                    <tr>
                        <th width="4.9%" class="text-center">No</th>
                        <th width="8%" class="text-center">Kode Pembelian</th>
                        <th width="10%" class="text-center">Tanggal</th>
                        <th width="16%" class="text-center">Nama Supplier</th>
                        <th width="13%" class="text-center">Total Bayar</th>
                        <th width="6.8%" class="text-center">Status</th>
                    </tr>
                </thead>
                <tbody>
                    @if ($hutang != NULL) 
