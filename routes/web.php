...
Route::group(['middleware' => 'auth'], function () {
        ...
        Route::group(['prefix' => 'super_admin', 'middleware' => 'cek-hak-akses:super_admin', 'as' => 'super_admin.'], function () {
                ...
                Route::post('/supplier-tambah', [SupplierController::class, 'store'])->name('supplier2.store');
        
                Route::resource('/pelanggan', PelangganController::class);
                Route::get('/pelanggan-tambah', [PelangganController::class, 'index2'])->name('pelanggan2');
                Route::post('/pelanggan-tambah', [PelangganController::class, 'store'])->name('pelanggan2.store');
        
                Route::resource('/users', UsersController::class);
                Route::get('/users-tambah', [UsersController::class, 'index2'])->name('pegawai2');
                Route::post('/users-tambah', [UsersController::class, 'store'])->name('pegawai2.store');
                Route::get('/profile', [UsersController::class, 'profile'])->name('profile');
                Route::post('/profile', [UsersController::class, 'profileUpdate'])->name('profile.store');
                Route::get('/changePW', [UsersController::class, 'changePW'])->name('changePW');
                Route::post('/changePW', [UsersController::class, 'chawngePWUpdate'])->name('changePW.store');
                ...
                Route::post('/stock-opname', [StokOpnameController::class, 'updateStock'])->name('stockOpname.store');
