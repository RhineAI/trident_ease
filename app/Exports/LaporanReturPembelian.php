...
class LaporanReturPembelian implements WithProperties, WithEvents, WithHeadings, FromCollection, WithTitle
{
    /**
    ...
    */
    ...
    public function properties(): array
    {
        return [
            ...
            'title'          => 'Export Excel Laporan Retur Pembelian',
            'description'    => 'Export Excel Data Laporan Retur Pembelian',
            'subject'        => 'Export Excel Laporan Retur Pembelian',
    ...
    {
        return 'Laporan Retur Pembelian';
    }
    ...
    public function collection()
    {
        $returPembelian = ReturPembelian::leftJoin('t_detail_retur_pembelian AS DRP', 'DRP.id_retur_pembelian', 't_retur_pembelian.id')
                        ...
                        ->whereBetween('t_retur_pembelian.tgl', [$this->awal, $this->akhir])
                        ->select('DRP.id_retur_pembelian', 'B.kode' ,'B.nama AS nama_barang', 'DRP.qty', 'DRP.sub_total')    
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event){
                ...
                $event->sheet->setCellValue('A1', 'Data Retur Pembelian');
